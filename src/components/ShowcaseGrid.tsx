      ...
      <div className="section-inner">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {items.map((item, index) => {
            ...
            const imageUrl =
              "image_url" in item && typeof item.image_url === "string" ? item.image_url : undefined;
            ...
            return (
              <article
                ...
                >
                <div className="relative h-48 overflow-hidden bg-[radial-gradient(circle_at_30%_20%,rgba(34,211,238,0.34),transparent_36%),linear-gradient(135deg,rgba(255,255,255,0.1),rgba(250,204,21,0.12))]">
                  {imageUrl ? (
                    <Image
                      src={imageUrl}
                    ...
                    <div
                      className="absolute inset-6 grid place-items-center rounded-2xl border border-white/10 bg-black/20 transition duration-300 group-hover:scale-105"
                      role="img"
